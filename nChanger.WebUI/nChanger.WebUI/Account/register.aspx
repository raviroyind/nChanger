<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="register.aspx.cs" Inherits="nChanger.WebUI.Account.register" %>
                ...
                <div class="ui large form container row">
                    <div class="ui stacked segment">
                        <div class="ui form">
                            ...
                            <div class="two fields">
                                <div class="field">
                                    ...
                                    <div class="field">
                                      ...
                                      <asp:CustomValidator ID="cvEMail" runat="server" ControlToValidate="txtEmailId"
                                        Display="Dynamic" ClientValidationFunction="validateEMail"
                                        OnServerValidate="cvEMail_ServerValidate" SetFocusOnError="True" ValidateEmptyText="True"/>
                                        <asp:Label ID="lblSpan" runat="server" Text=""></asp:Label>
                            ...
                            <div class="two fields">
                                <div class="field">
                                    <label>City<asp:Button ID="Button1" runat="server" Text="Button" />
                                    </label>
                                    &nbsp;<div class="field">
    ...
    <script type="text/javascript">
        ...
        function validateEMail(source, arguments) {
            ...
            $.ajax({
                ...
                url: "../services.asmx/validateEMail",
                data: "{'email': '" + arguments.Value + "'}",
                dataType: "json",
                async: false,
                success: function (result) {
                    $("#<%=lblSpan.ClientID %>").html(result.d.result);
